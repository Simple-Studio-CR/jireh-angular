...
export class InvoiceIVACodeService {
  ...
  public listAll(): Observable<any> {
    return this.http.get<InvoiceIVACode[]>(this.variables.getServicingEndpoint() + '/extras/ivaCode/all/', {headers: this.variables.getAuthHeader()})
      .pipe(catchError(err => {
            this.notAllowed(err);
